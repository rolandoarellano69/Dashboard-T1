...
//icons
import { RiBarChartFill, RiEarthFill, RiMenu3Line, RiHeadphoneLine, RiCalendarTodoFill, RiLogoutCircleRLine, RiCloseLine, RiArrowRightSLine } from 'react-icons/ri'
      ...
      <div className={`xl:h-[100vh] bg-secondary-100 xl:static overflow-y-scroll fixed w-[80%] lg:w-auto md:w-[40%] top-0 h-full p-4 flex flex-col justify-between z-50 ${showMenu ? "left-0" : "-left-full"} transition-all duration-500`}>
        <div>
          ...
          <ul>
            ...
            {/* submenu */}
            <li>
              <Link to="/admin/users " className=' flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-secondary-900 transition-colors'><MdOutlineSupportAgent className='text-primary' />Soporte Tecnico</Link>
            </li>
            <li>
