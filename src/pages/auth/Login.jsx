...
const Login = () => {
  ...
  return (
    <div className="bg-secondary-100 p-8 rounded-xl shadow-2xl w-auto lg:w-[450px]">
      <h1 className="text-4xl uppercase font-bold text-center text-white mb-8 tracking-[5px]">Iniciar sesión</h1>
      ...
      <form className="mb-4" >
        ...
        <div className="relative mb-4">
          ...
          <input type="email" className="py-3 pl-8 pr-4 bg-secondary-900 w-full outline-none rounded-lg " placeholder="Correo Electrónico" />
        </div>
